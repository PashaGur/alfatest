...
public class Task1_2 {
    ...
    public static void main(String[] args) {
        ...
        driver.findElement(By.xpath("//div[@class='theme_light']//a[contains(text(),'Наушники')]")).click();
        ...
        startPriceField.sendKeys("5000");
        driver.findElement(By.xpath("//label[text()='Beats']")).click();
...
//        driver.quit();
    ...
    private static void checkElementsSize(List<WebElement> webElements) {
